		...
		<div class="col-sm-12">
			...
			<spring:bind path="name">
				<div class="form-group">
					...
					<form:errors path="name"  class="form-error control-label" />
				</div>
			</spring:bind>
			...
			<spring:bind path="email">
				<div class="form-group">
					...
					<form:errors path="email" class="form-error control-label" />
				</div>
			</spring:bind>
			...
			<spring:bind path="address">
				<div class="form-group">
					...
					<form:input path="address" type="text"
						...
						<form:errors path="address" class="form-error control-label" />
				</div>
			</spring:bind>
			...
			<spring:bind path="country">
				<div class="form-group">
					...
					<form:errors path="country" class="form-error control-label" />	
				</div>
			</spring:bind>
			...
			<spring:bind path="sex">
				<div class="form-group">
					...
					<form:errors path="sex" class="form-error  control-label" />
				</div>
			</spring:bind>
